import { createDom, addClass, removeClass, hasClass } from 'xgplayer/src/utils/util'
...
let s_textTrack = function () {
  ...
  const container = createDom('xg-texttrack', `<div class="xgplayer-control-item_popover"><ul></ul></div><div class="name">${controlText}</div>`, {tabindex: 7}, 'xgplayer-texttrack')
